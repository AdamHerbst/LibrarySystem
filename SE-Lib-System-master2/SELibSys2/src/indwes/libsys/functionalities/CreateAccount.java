		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addGap(40)
								...
								.addGap(63).addComponent(txtFieldPassword, GroupLayout.PREFERRED_SIZE, 192,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup().addGap(38).addComponent(chckbxLibrarian,
								GroupLayout.PREFERRED_SIZE, 129, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup().addGap(173).addComponent(LoginButton,
						...
						.addGroup(groupLayout.createSequentialGroup().addGap(40)
								...
								.addGap(43)
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addComponent(lblCreateAnAccount).addComponent(txtFieldUsername,
												GroupLayout.PREFERRED_SIZE, 192, GroupLayout.PREFERRED_SIZE))))
				.addContainerGap(85, Short.MAX_VALUE)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup()
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup().addComponent(button).addGap(35))
						.addGroup(groupLayout.createSequentialGroup().addComponent(lblCreateAnAccount).addGap(18)))
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addGap(8).addComponent(usernameLabel,
				...
				.addGap(44)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addGap(8).addComponent(passwordLabel,
								GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
						.addComponent(txtFieldPassword, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE))
				.addGap(14).addComponent(chckbxLibrarian, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE)
				.addGap(7).addComponent(LoginButton, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)));
